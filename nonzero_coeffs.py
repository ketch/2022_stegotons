...
cells_per_layer = 100  # Should be even so that material interfaces align with grid
alpha = 0.5
KA    = 1.0
KB    = 4.0  # Was 4
rhoA  = 1.0
...
def setaux(x,rhoB=4,KB=4,rhoA=1,KA=1,alpha=0.5,xlower=0.,xupper=600.,bc=2):
    # Special version to get C11 not zero
...
def setup(use_petsc=0,kernel_language='Fortran',solver_type='classic',outdir='./_output',ic=1,
            tfinal=1000.,num_output_times=2000):
    ...
    qinit(state,ic=ic,a2=1.0,xupper=xupper)
